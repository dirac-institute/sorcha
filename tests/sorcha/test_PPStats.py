...
def test_PPStats(tmp_path):
    ...
    test_dict = {"ObjID":ObjID, "Linked":Linked, "optFilter":optFilter, "trailedSourceMag":trailedSourceMag, "phase_deg":phase_deg}
    ...
    expected_columns = np.array(['ObjID', 'isLinked', 'number_obs_r', 'med_apparent_mag_r',
       'min_apparent_mag_r', 'max_apparent_mag_r', 'max_phase_r',
       'min_phase_r', 'number_obs_g', 'med_apparent_mag_g',
       'min_apparent_mag_g', 'max_apparent_mag_g', 'max_phase_g',
       'min_phase_g'], dtype=object)
       
    assert_equal(expected_columns, stats_df.columns.values)
    
    # check correct population
    expected_row_one = np.array(['object_one', True, 6, 18.833333333333336, 18.0,
       19.666666666666668, 19.666666666666668, 18.0, 4, 20.5, 20.0, 21.0,
       21.0, 20.0], dtype=object)
    expected_row_two = np.array(['object_two', False, 5, 20.5, 19.0, 22.0, 22.0, 19.0, 0, 0.0, 0.0,
