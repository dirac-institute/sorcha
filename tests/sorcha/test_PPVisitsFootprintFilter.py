...
def test_is_on():
    ...
    onsensor, detectorId, _ = PPVisitsFootprint(
        field_df=field_df, query=query, visits_filename=visits_filename, ccd_num=3, plot=False
    )
...
def test_is_DES_on():
    ...
    # using the ra and dec of the centre of detector '0' for both visits
    ra = [
        305.683,  # top wall, centre left of ccd
    ...
    dec = [
        -50.795088,  # top wall, centre left of ccd
...
def test_des_k_num():
    ...
    # using the ra and dec of the centre of detector '0' for both visits
    ra = [
        305.683,  # top wall, centre of ccd
    ]

    dec = [
        -50.795088,  # top wall, centre of ccd
    ]
