...
The example configuration files are appropriate for setting up Sorcha to simulate what the LSST would discover. These examples come pre-installed with Sorcha. You use the **sorcha config prepare** command on the terminal to copy these files to your working directory. 
