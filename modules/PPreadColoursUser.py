...
The user may decide to give a single colour, or a uniform distribution of colours.
...
The also may also wish to amend the existing dataFrame with colours with another
colour. In that case, duplicate ObjID columns will be removed.
