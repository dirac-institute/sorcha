...
def test_PPConfigFileParser():
    ...
    test_configs = {'pointingFormat': 'whitespace',
                    ...
                    'ppdbquery': 'SELECT observationId, observationStartMJD, filter, seeingFwhmGeom, seeingFwhmEff, fiveSigmaDepth, fieldRA, fieldDec, rotSkyPos FROM observations order by observationId',
                    'cometactivity': 'none',
