...
def test_PPMatchPointingToObservations():
    ...
    test_oif = pd.DataFrame({'ObjID': ['356450', '356450'],
                             'FieldID': [9212, 9262],
    ...
    test_orb = pd.DataFrame({'ObjID': ['356450'],
                             't_0': [54466.0],
                             't_p': [90480.35745],
                             'argperi': [7.89],
                             'node': [144.25849],
    ...
    test_params = pd.DataFrame({'ObjID': ['356450'],
                                'H_r': [7.99],
                                'u-r': [2.55],
                                'g-r': [0.92],
                                'i-r': [-0.38],
    ...
    expected_df = pd.DataFrame({'ObjID': ['356450', '356450'],
                                'FieldID': [9212, 9262],
                                'FieldMJD': [60229.28437, 60229.308262],
                                'AstRange(km)': [5710968952.677331, 5710979387.71679],
                                'AstRangeRate(km/s)': [5.027, 5.082],
