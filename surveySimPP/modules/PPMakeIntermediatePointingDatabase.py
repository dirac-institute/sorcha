...
def PPMakeIntermediatePointingDatabase(oif_output,outf,chunkSize):
    """
    PPMakeIntermediatePointingDatabase.py
    
     Description: This task makes an intermediate pointing database from the output of
     ObjectsInField. This database is done in chunks to avoid memory problems.
