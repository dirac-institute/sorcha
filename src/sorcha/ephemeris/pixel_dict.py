...
class PixelDict:
    ...
    def __init__(self, jd_tdb, sim_dict, ephem, obsCode, observatory, picket_interval=1.0, nside=128, nested=True, n_sub_intervals=101):
    ...
    def get_object_unit_vectors(self, desigs, r_obs, t, lt0=0.01):
        ...
        for k in desigs:
            ...
            rho, rho_mag, lt, r_ast, v_ast = integrate_light_time(sim, ex, t-self.ephem.jd_ref, r_obs, lt0=lt0)
            rho_hat = rho/rho_mag
